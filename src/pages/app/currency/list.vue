...
export default {
    ...
    created() {
        ...
        this.currencyService = new CurrencyMfn(apiComp)
    }
}
</script>
    ...
    <div class="grid crud-demo">
        <div class="col-12">
            <div class="card">
                ...
                <DataTable ref="dt" v-model:selection="selectedProducts" :value="currencies" data-key="id" :paginator="true"
                    ...
                    <div class="field">
                        ...
                        <ClientOnly>
                            <Dropdown id="inventoryStatus" v-model="product.inventoryStatus" :options="statuses"
                                option-label="label" placeholder="Select a Status">
